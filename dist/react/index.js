...
const WebSocketProvider = ({ url, children, }) => {
    ...
    useEffect(() => {
        ...
        const messageHandler = (message) => setLastMessage(message);
    ...
    const sendMessage = useCallback((command, data, files, timeout) => {
...
export { WebSocketProvider, useWebSocket, useWebSocketTopic };
